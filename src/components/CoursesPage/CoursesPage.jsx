        ...
        return (
            <React.Fragment>
                ...
                <div className="inside">
                    ...
                    <p onClick={() => this.handleChange('hide1')} className="subtitle"><u> Curso Básico Open Water</u></p> <br />
                    ...
                    <p className="subtitle" onClick={() => this.handleChange('hide2')}><u>Scuba Review</u></p> <br />
                    ...
                    <p className="subtitle" onClick={() => this.handleChange('hide3')}><u> Curso Avançado Advanced Open Water</u></p> <br />
                    ...
                    <p className="subtitle" onClick={() => this.handleChange('hide4')}><u>Curso de Primeiros - Socorros Emergency First Response</u></p>
                    <br />
                    ...
                    <p className="subtitle" onClick={() => this.handleChange('hide5')}><u>Curso de Resgate Rescue Diver</u></p> <br />
                    ...
                    <p className="subtitle" onClick={() => this.handleChange('hide6')}><u>Curso Dive Master</u></p> <br />
                    ...
                    <br />
                    <p className="subtitle" onClick={() => this.handleChange('hide7')}><u> Cancelamentos</u></p> <br />
                    ...
                    <p className="subtitle" onClick={() => this.handleChange('hide8')}><u>Reembolsos</u></p> <br />
